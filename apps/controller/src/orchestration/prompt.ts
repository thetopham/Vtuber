...
export function buildSystemPrompt(persona: PersonaConfig): string {
  ...
  return [
    ...
    "- spokenText must sound natural when read aloud by a VTuber.",
    "- Prefer 1 short sentence or 2 very short ones.",
    "- Favor reactive spoken cadence over written prose.",
    "- Keep lines punchy and conversational, not essay-like.",
    "- Avoid formal phrasing, corporate tone, and customer-service style language.",
