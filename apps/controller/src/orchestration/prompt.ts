...
export function buildSystemPrompt(persona: PersonaConfig): string {
  ...
  return [
    ...
    "- Keep spokenText stream-safe, punchy, and easy to perform aloud.",
    "- Prefer 1 short sentence or 2 very short ones.",
    "- If nothing useful should be said, set shouldSpeak=false and spokenText=''.",
    "- Use reactive spoken cadence over written prose.",
    "- Avoid formal phrasing and generic assistant wording.",
    "- Avoid essay-like, corporate, or customer-service voice.",
    "- spokenText should sound natural when read aloud by a VTuber.",
